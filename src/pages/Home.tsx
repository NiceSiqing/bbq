  ...
  return (
    <>
      ...
      <div className="w-full h-140 flex flex-col  justify-center bg-black px-16 relative ">
        ...
        <a href="/menu" className="absolute text-white bg-red-600 z-10 px-8 py-2 text-2xl font-bold rounded-xs bottom-1 translate-y-1/2 left">Menu</a>
      </div>
      ...
      <div className="w-full h-167 flex flex-col bg-white px-7 items-center ">
        ...
        <a href="/menu" className="w-30 text-center text-white bg-red-600 px-4 py-2 text-2xl font-bold rounded-xs">Menu</a>
      </div>
